    ...
    <div class="test-interface">
      ...
      <div ref="messagesContainer" class="messages-container" @scroll="handleScroll">
        ...
        <div v-if="messages.length === 0" class="welcome-message">
          ...
          <p>Ask me anything about the Dawntasy universe or any other topic!</p>
...
// Send message to API using server route - SECURITY FIXED! 🔒
const sendMessage = async (text) => {
  ...
  try {
    ...
    // Use the server API endpoint instead of direct OpenAI call
    // This leverages your existing backend to handle API keys securely
    ...
    const aiContent = response.data.message || 
                     (response.data.body && response.data.body.message) || 
                     "I'm experiencing some cosmic disturbances.";
